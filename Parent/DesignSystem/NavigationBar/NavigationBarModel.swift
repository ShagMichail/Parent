...
struct NavigationBarModel {
    ...
    init(mainTitle: String? = nil, chevronBackward: Bool? = nil, subTitle: String? = nil, hasNotification: Bool? = nil, hasNewNotification: Bool? = nil, hasConfirm: Bool? = nil, onBackTap: @escaping () -> Void, onNotificationTap: @escaping () -> Void, onConfirmTap: @escaping () -> Void) {
