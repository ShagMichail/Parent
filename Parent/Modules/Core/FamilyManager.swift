...
//    }
//    
//    // MARK: - Проверка существующего пользователя
//    func checkExistingUser() -> Bool {
//        // Проверяем, есть ли сохраненный пользователь
//        // В реальном приложении здесь будет проверка в UserDefaults/Keychain
//        return currentUser != nil
//    }
//    
//    // MARK: - Настройка Family Sharing (только для родителя)
//    func setupFamilySharing() async throws {
//        print("🔄 Начинаем настройку Family Sharing...")
//        
...
//    func createUser(name: String, appleId: String, role: MemberType) {
...
//        currentUser = user
//        
//        // Если это родитель - настраиваем Family Sharing
//        if role == .parent {
//            Task {
//                do {
//                    try await setupFamilySharing()
//                } catch {
//                    print("⚠️ Ошибка настройки Family Sharing: \(error)")
//                    // Но пользователь все равно создан
//                }
//            }
//        }
//        
//        // Сохраняем пользователя (в реальном приложении - в UserDefaults/Keychain)
//        saveUserToStorage(user)
//        
//        print("✅ Пользователь создан: \(name)")
//    }
//    
//    // MARK: - Загрузка членов семьи (только для родителя)
//    private func loadFamilyMembers() async {
//        print("👨‍👩‍👧‍👦 Загружаем членов семьи...")
//        
//        // В реальном приложении здесь будет загрузка из FamilyControls
//        // Пока используем демо-данные
//        
//        let demoMembers = [
//            FamilyMember(
//                id: UUID().uuidString,
//                name: "Детское устройство 1",
//                type: .child,
//                appleId: "child1@family.com",
//                deviceId: UUID().uuidString
//            ),
//            FamilyMember(
//                id: UUID().uuidString,
//                name: "Детское устройство 2",
//                type: .child,
//                appleId: "child2@family.com",
//                deviceId: UUID().uuidString
//            )
//        ]
//        
//        await MainActor.run {
//            self.familyMembers = demoMembers
//            self.selectedChild = demoMembers.first
//        }
//        
//        print("✅ Загружено членов семьи: \(demoMembers.count)")
//    }
//    
//    // MARK: - Сохранение/загрузка пользователя
//    private func saveUserToStorage(_ user: FamilyMember) {
//        // В реальном приложении сохраняем в UserDefaults или Keychain
...
//        currentUser = user
//        
//        // Если это родитель - загружаем членов семьи
//        if role == .parent {
//            Task {
//                await loadFamilyMembers()
//            }
